...
const CreditCards = () => {
  ...
  const areCardsActuallyPaid = () => {
    ...
    // También verificar si cada tarjeta individual tiene un pago registrado
    ...
    // Devolver true solo si hay un pago global O si todas las tarjetas relevantes están pagadas
    return globalPaymentExists || (allRelevantCardsPaid && anyCardHasPaidRecord);
  };
  ...
  const checkMonthPaymentStatus = async () => {
    try {
      ...
      // Si no hay tarjetas con saldo, deshabilitar el botón
      ...
      // Si todas las tarjetas con saldo están pagadas, deshabilitar el botón
      if (allCardsPaid) {
        // Ya no necesitamos modificar paymentDisabled aquí
        // setPaymentDisabled(true);
        setPaymentStatusChecked(true);
              ...
              <Box sx={{ 
                ...
                >
                  ...
                  <Button
                    ...
                    disabled={(() => {
                      // Si no hay gastos, desactivar el botón
                      if (getAllCardsTotal() <= 0) return true;
                      
                      // Si ya está pagado, desactivar el botón
